...
public class RedisConfig extends CachingConfigurerSupport {
	...
	private Map<String, RedisCacheConfiguration> getRedisCacheConfigurationMap() {
		...
		/** 缓存微信AccessToken 过期时间 7100秒 **/
		redisCacheConfigurationMap.put("weixinAccessToken", this.getRedisCacheConfigurationWithTtl(7100));
		redisCacheConfigurationMap.put("loginToken", this.getRedisCacheConfigurationWithTtl(8*3600));
	...
	class DataJedisProperties {
		...
		JedisConnectionFactory jedisConnectionFactory() {
			 ...
			 * factory.setTimeout(timeout); factory.setPassword(password);
			 * return factory;
			 */
			...
			JedisClientConfiguration.JedisClientConfigurationBuilder jedisClientConfiguration = JedisClientConfiguration
					.builder();
			jedisClientConfiguration.connectTimeout(Duration.ofMillis(timeout));// connection
																				// timeout
